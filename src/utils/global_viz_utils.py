...
class scatter(): 
    """
    New scatter class to update the size of the markers when resizing the figure, 
    from https://stackoverflow.com/questions/48172928/scale-matplotlib-pyplot-axes-scatter-markersize-by-x-scale/48174228#48174228
    """
